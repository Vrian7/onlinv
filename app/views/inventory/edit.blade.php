...
<form class="form-horizontal" method="POST" action="{{asset('inventario/editar/'.$inventory->public_id)}}">
<div class="col-lg-12">
    <div class="box dark">
        <header>
        ...
        <div id="div-1" class="accordion-body collapse in body">            
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-8">
                        <input type="text" value="{{$inventory->stock}}" placeholder="Cantidad del producto" name="stock" class="form-control" />
                    </div>
                </div>
                <div class="form-group">
                    <label for="text1" class="control-label col-lg-4">Promedio</label>
                    <div class="col-lg-8">
                        <input type="text" value="{{$inventory->average}}" placeholder="Ingrese la cantidad promedio que tiene el producto" name="average" class="form-control" />
                    </div>
                </div>
                <div class="form-group">
                    <label for="text1" class="control-label col-lg-4">M&iacute;nimo</label>
                    <div class="col-lg-8">
                        <input type="text" value="{{$inventory->minimum}}" placeholder="Se lanza una alerta cuando el producto llege a esta cantidad" name="minimum" class="form-control" />
                    </div>
                </div>
                <div class="form-group">
                    <label for="text1" class="control-label col-lg-4">Descripci&oacute;n</label>
                    <div class="col-lg-8">
                        <input type="text" value="{{$inventory->description}}" placeholder="Descripci&oacute;n del inventario" name="description" class="form-control" />
                    </div>
                </div>                
