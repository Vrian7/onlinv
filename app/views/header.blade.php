	        ...
	        <div id="top">
	            ...
	            <nav class="navbar navbar-inverse navbar-fixed-top " style="padding-top: 10px;">
	                ...
	                <header class="navbar-header">
	                    ...
	                    <img src="{{asset('vendor/bcore/img/logo_factufacil.png')}}" alt="" />
	                ...
	                <ul class="nav navbar-top-links navbar-right">
	                            ...
	                            <li>
	                                <a href="{{asset('notificacion/'.$notification->public_id)}}">
	                                    ...
	                                    <div>{{$notification->message}}
	                                        <br />
	                                        <span class="label {{$alert->description}}">{{$notification->name}}</span> 
	                    ...
	                    <li class="dropdown">
	                        <a class="dropdown-toggle" data-toggle="dropdown" href="#">
	                            <span class="label label-danger">5</span>   <i class="icon-warning-sign"></i>&nbsp; <i class="icon-chevron-down"></i>
	                        </a>
	                       <ul class="dropdown-menu dropdown-messages">
	                       	<?php 	                       		
