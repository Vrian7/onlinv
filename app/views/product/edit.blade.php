...
<form class="form-horizontal" method="POST" action="{{asset('producto/editar/'.$product->public_id)}}">
<div class="col-lg-12">
    <div class="box dark">
        <header>
        ...
        <div id="div-2" class="accordion-body collapse collapsed body">            
            ...
            @if(isset($custom->field1) )
                ...
                <div class="form-group" id="extra1">
                    ...
                    <div class="col-lg-8">
                        <input type="text" value="{{$product->extra1}}" placeholder="Campo personalizado." name="field1" class="form-control" />
                    </div>
                </div> 
                @endif
                @if($custom->field2)
                <div class="form-group" id="extra2">
                    ...
                    <div class="col-lg-8">
                        <input type="text" value="{{$product->extra2}}" placeholder="Campo personalizado." name="field2" class="form-control" />
                    </div>
                </div> 
                @endif
                @if($custom->field3)
                <div class="form-group" id="extra3">
                    ...
                    <div class="col-lg-8">
                        <input type="text" value="{{$product->extra3}}" placeholder="Campo personalizado." name="field3" class="form-control" />
                    </div>
                </div> 
                @endif
                @if($custom->field4)
                <div class="form-group" id="extra4">
                    ...
                    <div class="col-lg-8">
                        <input type="text" value="{{$product->extra4}}" placeholder="Campo personalizado." name="field4" class="form-control" />
                    </div>
                </div> 
                @endif
                @if($custom->field5)
                <div class="form-group" id="extra5">
                    ...
                    <div class="col-lg-8">
                        <input type="text" value="{{$product->extra5}}" placeholder="Campo personalizado." name="field5" class="form-control" />
                    </div>
                </div> 
                @endif
            @endif
