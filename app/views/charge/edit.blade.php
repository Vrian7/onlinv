...
<form class="form-horizontal" method="POST" action="{{asset('cobro/editar/'.$charge->public_id)}}">
<div class="col-lg-12">
    <div class="box dark">
        <header>
        ...
        <div id="div-1" class="accordion-body collapse in body">            
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-8">
                        <input type="text" value="{{$charge->amount}}" placeholder="Monto del pago efectuado" name="amount" class="form-control" />
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-8">
                        <input type="text" value="{{$charge->date}}" name="date" class="form-control" placeholder="Fecha del cobro" data-date-format="dd/mm/yyyy" id="date" />
                    </div>
                </div>                            
                <div class="form-group">
                    <label for="text1" class="control-label col-lg-4">Descripci&oacute;n</label>
                    <div class="col-lg-8">                        
                        <input type="text" value="{{$charge->description}}"  placeholder="detalle del pago" name="description" class="form-control" />
                    </div>
                </div>  
        </div>
