    ...
    <div class="col-lg-12">
        <div class="box primary">            
            <header>
                    ...
                    <div class="toolbar">
                        <a class="btn btn-success btn-sm btn-grad" href="{{asset('campos_cliente')}}">Nuevo</a>
                    </div>
                </header>
...
<div class="col-lg-12">
    ...
    <div class="col-lg-2"><a class="btn btn-warning" href="{{asset('inicio')}}"><i class="icon-ban-circle icon-white"></i> Cancelar</a></div>
