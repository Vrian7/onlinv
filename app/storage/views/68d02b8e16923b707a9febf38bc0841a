...
class MYPDF extends TCPDF {
    public function Footer() {
        ...
        $html = '<hr><table border="0">
            <tr>
            <td align="center">Sistema de Cotización Computarizada <b>www.factufacil.online</b></td>
            </tr>
            <tr>
...
$numeroCotizacion = $invoice->number;
...
//borde cotizacion
//logo
$imgdata = asset('uploads/logos/'.$logo);
...
foreach ($products as $key => $product){
        ...
        <td width="35" align="center" style="color:#003468;">'.$brand->name.'</td>
        <td width="35" align="center" style="color:#003468;">'.$unit->name.'</td>
...
$pdf->SetFont('helvetica', '', 8);
        $texPie .='
        <br><br>
        <table border="0.3" cellpadding="3" cellspacing="0">
            <tr>
                <td width="160" style="color:#003468;"><b>TOTAL COTIZACION USD </b></td>
                <td  width="70" align="right" style="color:#003468;"><b>'.$total.'</b></td>
            </tr>
            <tr>
                <td width="160" style="color:#003468;"><b>TOTAL COTIZACION Bs.</b></td>
...
$pdf->writeHTMLCell($w=0, $h=0, '97', '', $texPie, $border=0, $ln=1, $fill=0, $reseth=true, $align='left', $autopadding=true);
//terminos
$line=60;
...
$pdf->SetFont('helvetica', '', 8);
        ...
        <table border="0.3" cellpadding="3" cellspacing="0">
            <tr>
                <td width="160" style="color:#003468;"><b>TOTAL COTIZACION US$ </b></td>
                <td  width="70" align="right" style="color:#003468;"><b>'.$total.'</b></td>
            </tr>
            <tr>
                <td width="160" style="color:#003468;"><b>TOTAL COTIZACION Bs.</b></td>
